...
class SearchAdapter(
    private val listener: OnSearchArticleClickListener?
) : ListAdapter<Article, SearchAdapter.ViewHolder>(ArticleDiffCallback()) {
    ...
    fun interface OnSearchArticleClickListener {
